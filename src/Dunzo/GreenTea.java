...
public class GreenTea extends Beverage {
    ...
    protected GreenTea(Builder builder) {
        super(builder);
    }

    public static void loadConfig(int hotWater, int gingerSyrup, int sugarSyrup, int greenMixture) {
        beverage = Beverage.newBuilder().addHotWater(hotWater).addGingerSyrup(gingerSyrup)
                .addSugarSyrup(sugarSyrup).addGreenMixture(greenMixture).build();
    }
    ...
    public static Beverage get() {
        return Beverage.newBuilder().addHotWater(beverage.getHotWater()).addGingerSyrup(beverage.getGingerSyrup())
                .addSugarSyrup(beverage.getSugarSyrup()).addGreenMixture(beverage.getGreenMixture()).build();
    }
    ...
    public static void checkInsufficientIngredients(List<String> insufficientIngredients, List<String> unavailableIngredients,
        ...
        check(insufficientIngredients, unavailableIngredients, totalCapacity.getGreenMixture(), beverage.getGreenMixture(), "Green Mixture");
    }
}
